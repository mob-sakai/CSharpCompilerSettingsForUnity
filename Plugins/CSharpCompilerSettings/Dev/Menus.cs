...
namespace Coffee.CSharpCompilerSettings
{
    internal static class Menus
    {
        ...
        private const string k_EditorAsmdef = "Packages/com.coffee.csharp-compiler-settings/Plugins/CSharpCompilerSettings/Dev/CSharpCompilerSettings.Editor.asmdef~";
        private const string k_EditorAsmdefDevelop = "Packages/com.coffee.csharp-compiler-settings/Plugins/CSharpCompilerSettings/Dev/CSharpCompilerSettings.Editor.asmdef.dev~";
